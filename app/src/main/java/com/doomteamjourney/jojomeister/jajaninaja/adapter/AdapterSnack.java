...
public class AdapterSnack extends RecyclerView.Adapter<AdapterSnack.HolderSnack> {
    private List<ModelSnack> listItem;
    private Context mContext;

    public AdapterSnack(List<ModelSnack> listItem, Context mContext) {
    ...
    @NonNull
    @Override
    public HolderSnack onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_menu,parent,false);
        AdapterSnack.HolderSnack holderM = new AdapterSnack.HolderSnack(layout);
        return holderM;
    }

    @Override
    public void onBindViewHolder(@NonNull HolderSnack holder, int position) {
        ModelSnack mk = listItem.get(position);
    ...
    public class HolderSnack extends RecyclerView.ViewHolder{
        public TextView txNamaMenu, txHarga;
        public ImageView gbrMenu;
        public ImageButton gbrPesan;
        public ModelSnack mk;

        public HolderSnack (View v){
            super(v);
