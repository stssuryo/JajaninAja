...
public class ModelEsKrim {
    ...
    public ModelEsKrim(String id_menu, String id_penjual, String nama_menu, int harga_menu, String jenis_menu, String foto, String stand) {
